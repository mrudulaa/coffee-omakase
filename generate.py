...
courses = [
    {
        ...
        "pairing": "Cardamom Knot · orange blossom, pistachio",
        "pairing_status": "set",
        "prev": None,
        "next": "02-colombia",
    },
    {
        ...
        "pairing": "Miso Financier · white miso, brown butter, hazelnut",
        "pairing_status": "set",
        "prev": "01-ethiopia",
        "next": "03-kenya",
    },
    {
        ...
        "pairing": "Yuzu Canelé · yuzu, vanilla, caramel crust",
        "pairing_status": "set",
        "prev": "02-colombia",
        "next": "04-yuzu-cooler",
    },
    {
        ...
        "variant": "shop",
        "origin_slug": "yuzu",
        "origin": "Specialty · Clarified milk punch",
        "name": "Jasmine-Lychee Milk Punch",
        "role": "Echoes the Ethiopia's jasmine, bergamot, limeade energy",
        "notes": ["clarified Brazil cold brew", "lychee", "yuzu", "white grape", "jasmine N₂O foam"],
        "brew_specs": [
            ("Base", "Brazil cold brew, 1:8"),
            ("Punch", "Lychee + yuzu + white grape"),
            ("Clarify", "Milk-wash, V60-strain overnight"),
            ("Foam", "Jasmine N₂O, Methocel-stabilized"),
            ("Serve", "Frozen coupe, jasmine flower garnish"),
        ],
        "pairing": None,
    ...
    },
    {
        ...
        "variant": "journal",
        "origin_slug": "cherry",
        "origin": "Specialty · Layered matcha",
        "name": "Cherry Earl Grey Matcha",
        "role": "Earl Grey bridges to the Colombia's tea-like finish; cherry adds a refined fruit expression",
        "notes": ["tart cherry puree", "Earl Grey cold-steeped milk", "ceremonial matcha"],
        "brew_specs": [
            ("Cherry", "Tart cherry puree, lemon-bright"),
            ("Milk", "Earl Grey cold-steep, 12–24 hr"),
            ("Matcha", "30 g ceremonial / 750 ml at 80°C"),
            ("Build", "Layered — cherry, milk, matcha float"),
    ...
    },
    {
        ...
        "name": "Cardamom Brown Butter Nitro Latte",
        "role": "Rich, aromatic counterweight to the Kenya's sharp finish",
        "notes": ["brown butter", "cardamom", "vanilla bean", "smoked sea salt"],
        "brew_specs": [
            ("Syrup", "Brown butter + brown sugar + cardamom"),
            ("Finish", "Maldon Smoked sea salt"),
            ("Base", "Brazil nitro cold brew"),
            ("Milk", "Oatly Barista"),
            ("Charge", "N₂O, Nitropress"),
        ],
        "pairing": None,
        "pairing_status": "coming",
